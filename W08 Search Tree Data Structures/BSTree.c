...
// scp BSTree.c BSTree.h z5114919@login.cse.unsw.edu.au:~/9024/pracs/prac_8
...
int TreeHeight(Tree t)
{
   ...
   if (t == NULL)
   {
      // If there are no more links then return 0;
      return 0;
   }
   else
   {
      ...
      if (right(t) == NULL) {
         ...
         right_height = 1 + TreeHeight(right(t));
      }
      ...
      if (left(t) == NULL) {
         ...
         left_height = 1 + TreeHeight(left(t));
      }
...
int TreeWidth(Tree t)
{
   ...
   if (t == NULL)
      ...
      width += 3;
   width += TreeWidth(right(t));
   width += TreeWidth(left(t));
   return width;
}
